...
def get_custom_rates(banner_name):
    ...
    elif banner_name in ['Yuffie 24K', 'Zack 24K', 'Elena/Morgana 24K', 'Rivera 12K']:
        regular = {
            'rainbowRate' : 0.05,
...
def special_case_rates(pull_type, rate_up_multiplier):
    ...
    """
    if pull_type == 'guaranteedRainbowWithRateUp' and rate_up_multiplier == 3:
        return (0.10, 0.90) #BM Golbez: 10% on banner, 90% off
    elif pull_type == 'guaranteedRainbowWithRateUp' and rate_up_multiplier == 5:
