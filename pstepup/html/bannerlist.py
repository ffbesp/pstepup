...
def main():
    template_vars = { 'title' : 'Banners - ' + sitesettings.SITE_NAME,
    ...
    html_file_loc = os.path.join(os.getcwd(), os.pardir, os.pardir, os.pardir, 'ffbesp.github.io', 'banner', 'index.html')
